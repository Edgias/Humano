        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeDeduction = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CompanyContribution = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeBenefits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradeBenefits_Benefits_BenefitId",
                        column: x => x.BenefitId,
                        principalTable: "Benefits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeBenefits_Grades_GradeId",
                        column: x => x.GradeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidentialAddress_Street = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    ResidentialAddress_City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ResidentialAddress_State = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    ResidentialAddress_Country = table.Column<string>(type: "nvarchar(90)", maxLength: 90, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsSoftDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Employees_Salutations_SalutationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeIn = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    TimeOut = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsSoftDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkExperience_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkExperience_JobTitles_JobTitleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourPeriod = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveDays_Leaves_LeaveId",
                        column: x => x.LeaveId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryAdjustments_WorkExperience_WorkExperienceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkExperienceBenefits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkExperienceBenefits_Benefits_BenefitId",
                        column: x => x.BenefitId,
                        principalTable: "Benefits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkExperienceBenefits_WorkExperience_WorkExperienceId",
                        column: x => x.WorkExperienceId,
                        principalTable: "WorkExperience",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_SalutationId",
                table: "Employees",
                column: "SalutationId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeBenefits_BenefitId",
                table: "GradeBenefits",
                column: "BenefitId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeBenefits_GradeId",
                table: "GradeBenefits",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveDays_LeaveId",
                table: "LeaveDays",
                column: "LeaveId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryAdjustments_WorkExperienceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperience_GradeId",
                table: "WorkExperience",
                column: "GradeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkExperienceBenefits_BenefitId",
                table: "WorkExperienceBenefits",
                column: "BenefitId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkExperienceBenefits_WorkExperienceId",
                table: "WorkExperienceBenefits",
                column: "WorkExperienceId");
        }
